...
// Target Distance
#define _DIST_TARGET    240 // Center of the rail (unit:mm)

// PID parameters
#define _KP 3.7  // proportional gain
#define _KD 1151  // derivative gain
...
void setup() {
  ...
  dist_ema = volt_to_distance(ir_sensor_filtered(20, 0.5, 0));
...
float volt_to_distance(int a_value)
{
  ...
  //return 831 + (-3.78 * a_value) + (4.04 * 0.001 * pow(a_value, 2)) + 10;
  return 673 -2.57 * a_value + 2.53*0.001*a_value * a_value -2.2 * 0.0000001 * a_value * a_value * a_value;
}
