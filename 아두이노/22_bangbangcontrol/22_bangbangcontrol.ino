...
#define _INTERVAL_DIST    1 // distance sensor interval (unit: ms)
...
// Target Distance
#define _DIST_TARGET    150 // Center of the rail (unit:mm)
...
float volt_to_distance(int a_value)
{
  ...
  return 831 + (-3.78 * a_value) + (4.04E-03 * pow(a_value, 2));
}
