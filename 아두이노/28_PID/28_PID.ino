...
#define _EMA_ALPHA 0.04    // EMA weight of new sample (range: 0 to 1)
                          // Setting EMA to 1 effectively disables EMA filter

// Servo adjustment - Set _DUTY_MAX, _NEU, _MIN with your own numbers
#define _DUTY_MAX 1740 // 7500
#define _DUTY_NEU 1146 // 
#define _DUTY_MIN 509 // 400

#define _SERVO_ANGLE_DIFF  120  // Replace with |D - E| degree
#define _SERVO_SPEED       800  // servo speed 

// PID parameters
#define _KP 5.7 //6  // proportional gain
#define _KD 530  // derivative gain
#define _KI 0.0000008 //0.0000085   // integral gain

const int MAX_ARRAY_SIZE = 9;
float dist_filteredArray[MAX_ARRAY_SIZE];
int arrayIndex = 0;
...
////////////////////////////////////////////////////////////////////////
  ...
  if (event_dist) {
    ...
    dist_filteredArray[arrayIndex]  = dist_filtered;
    if (++arrayIndex >= MAX_ARRAY_SIZE) {
      dist_filtered = dist_filteredArray[4];
      for (int i = 0; i < MAX_ARRAY_SIZE; i++) {
        dist_filteredArray[i] = 0.0;
      }
      arrayIndex = 0;
    }
...
float volt_to_distance(int a_value)
{
  ...
  return 768 -3.59 * a_value + 6.04*0.001*a_value * a_value -3.6 * 0.000001 * a_value * a_value * a_value;
}
